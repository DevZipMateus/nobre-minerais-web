      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="font-sans text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="flex justify-center">
            <img
              ...
              className="w-2/3 md:w-1/2 h-auto rounded-lg shadow-2xl"
            />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="font-sans text-gray-600 leading-relaxed mb-6 text-center">
